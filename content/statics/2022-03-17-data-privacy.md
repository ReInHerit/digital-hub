...
**B. Credit**\
This document was created using a template from SEQ Legal (seqlegal.com) and Website Planet ([www.websiteplanet.com](https://www.websiteplanet.com)). 
...
3. ~~information, such as your name and email address, that you enter in order to set up subscriptions to our emails and/or newsletters~~ *Newsletter via Hub?*
...
6. information that you provide for us with the intention of publishing it on our website, which includes your username, e-mail adress, and the content of your posts; 
...
3. ~~sending you our email newsletter, if you have requested it (you can inform us at any time if you no longer require the newsletter);~~ *Newsletter via the hub?*
4. ~~providing third parties with statistical information about our users (but those third parties will not be able to identify any individual user from that information);~~ *dont think so?*
...
7. verifying compliance with the terms and conditions governing the use of our website (~~including monitoring private messages sent through our website private messaging service~~); and
8. other uses.
...
~~Except as provided in this policy, we will not provide your personal information to third parties~~. *kinda tricky but we work with github so we disclose nothing, am i wrong????*
...
1. **the supply of appropriate evidence of your identity ({ADJUST TEXT TO REFLECT YOUR POLICY for this purpose, we will usually accept a photocopy of your passport certified by a notary plus an original copy of a utility bill showing your current address}). *???***
