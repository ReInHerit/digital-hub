...
const CMSDesc = () => {
  ...
  return <BaseLayout>
    ...
    <h2 className="h5">Netlify CMS</h2>
        ...
        <ol>
          <li>Anonymous: no account whatsoever, see public chatroom content, read digi hub --- </li>
          <li>Unknown (account - OAUTH via github / twitter / gitlab): join public rooms, get invited to all rooms, add people (when access to chatroom), no CMS --- No Reinherit Github member + No Team Moderator + Any OAUTH method</li>
