  ...
  return (
    <BaseLayout pageTitle="Data protection | ReInHerit Digital Hub">
      <Container>
        ...
        <ul>
          <li>
            The privacy of our website visitors is very important to us, and we
            are committed to safeguarding it. This policy explains what we will
        ...
        <p>
          ...
          (seqlegal.com) and Website Planet (www.websiteplanet.com).
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            it on our website, which includes your username, e-mail adress, and
        ...
        <ol>
          ...
          <li>
            Without prejudice to article G-2, we will usually delete personal
            data falling within the categories set out below at the date/time
            set out below:
          </li>
          <li>
            Notwithstanding the other provisions of this Section G, we will
            retain documents (including electronic documents) containing
            personal data: a) to the extent that we are required to do so by
            law; b) if we believe that the documents may be relevant to any
            ongoing or prospective legal proceedings; and c) in order to
          ...
          <li>
            <ul>
              ...
              <li>
                ...
                the “Customize and control” menu, and clicking “Settings,” “Show
                advanced settings,” and “Clear browsing data,” and then
                selecting “Delete cookies and other site and plug-in data”
