...
import QuestionThreeCraftmanship from "../../../../../components/shared/ExhibitionQuestions/inGalleryCraftmanship/C_questionCraftmanshipENGraz"
...
<div className="craftmanshipQuestions exh_question_intro_text">
          <div className="d-flex justify-content-end">
            ...
            <Link to="/exhibitions/craftmanship/inGalleryDE/3rdQuestionCraftmanshipDE/#Question3CraftmDE" style={{ color: "white" }} className="text-decoration-none">German</Link></h2></Badge>
          </div>
          </div>
