          ...
          <SideMainLayout
            side={
              <div className="bg-white card p-4 mb-2 border-0 shadow">
                ...
                <br />
                <div>
                <a style={{borderRadius:0}} href={frontmatter.mainImage} download="factsheet_pdf" className="btn btn-info border-radius-0" target="_blank" rel="noreferrer">Download PDF</a>
                </div>
              </div>
            }
          >
