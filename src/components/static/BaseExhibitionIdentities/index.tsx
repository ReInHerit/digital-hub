...
import ReinNavbarExhibIdentities from "../navbarExhibitionIdentities"
...
const BaseExhibitionIdentities = ({ children, pageTitle }: Props) => {
  return (
    <Base>
      <Head pageTitle={pageTitle}></Head>
      <ReinNavbarExhibIdentities/>
      <Container
      ...
      <Container
        ...
        fluid>
          ...
          <Row>
          <Col className="exh_footer_links_red">
...
export default BaseExhibitionIdentities
