...
const QuestionThreeCraftmanship = () => {
    ...
    const currentCountryC = typeof window !== 'undefined' ? localStorage.getItem('countryCraftmanship') : null
...
// these set the answer, once clicked, within the Form - the recorded value is stored as "answerThree"
    ...
    const handleSubmitC = async (e) => {
        ...
        window.location.href = "exhibitions/craftmanship/CraftmanshipExhibitionOverview";
      };
