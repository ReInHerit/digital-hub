...
const LatestFeedTechnology: React.FC = () => {
  const Technology: LatestPosts.Data = useStaticQuery(LATEST_TECHNOLOGY_QUERY)
  
  return (
    <CardGroup>
    {Technology.allMarkdownRemark.edges.map((latestFeed, i) => (
       <Card
...
export default LatestFeedTechnology;

const LATEST_TECHNOLOGY_QUERY = graphql`
query Technology($date: DateQueryOperatorInput = {}) {
  allMarkdownRemark(
    filter: {frontmatter: {theme: {eq: "Technology"}, date: $date}}
    limit: 3
